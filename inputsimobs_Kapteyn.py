...
#
i_orbit = 70.0
mp_Mearth = 7.0 / sin(radians(i_orbit))

# a_AU = 0.3145289932140786
P_day = 121.54
...
ascend_node_Omega =  radians(70.) # 0-360
# periapsis_omega: phase
periapsis_omega = radians(3.9+180.)  # 0-360
periapsis_omega_in = radians(3.9)
# M0: phase
M0 = radians(357.6) # 0-360
T0 = 2452985.74111
#
